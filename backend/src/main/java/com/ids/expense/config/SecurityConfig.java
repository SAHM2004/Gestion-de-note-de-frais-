...
import com.ids.expense.auth.security.JwtAuthenticationFilter;
import com.ids.expense.auth.security.UserDetailsServiceImpl;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/**").authenticated() // Le reste nécessite authentification
